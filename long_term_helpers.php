...
// Fetch helpers who have worked with the same user multiple times
$sql = "
    SELECT 
        h.helper_id, 
        h.name, 
        ...
        h.address, 
        h.phone_number,
        COUNT(hr.hiring_id) AS user_hirings
    FROM 
        helpers h
    LEFT JOIN 
    ...
    HAVING user_hirings > 1
    ORDER BY user_hirings DESC, h.rating DESC;
";
...
<head>
    ...
    <title>Long-Term Helpers - TogetherA+</title>
...
<body>
    ...
    <main>
        <h1 style="text-align: center; margin-bottom: 20px;">Long-Term Helpers</h1>
